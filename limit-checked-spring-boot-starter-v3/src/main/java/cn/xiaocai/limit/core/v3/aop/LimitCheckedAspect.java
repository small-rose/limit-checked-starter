package cn.xiaocai.limit.core.v3.aop;


import cn.xiaocai.limit.core.v3.annotation.LimitChecked;
import cn.xiaocai.limit.core.v3.auto.LimitCheckedProperties;
import cn.xiaocai.limit.core.v3.cache.MyCacheManager;
...
public class LimitCheckedAspect {
     ...
     */
    @Order(100)
    @Pointcut("@annotation(cn.xiaocai.limit.core.v3.annotation.LimitChecked)")
