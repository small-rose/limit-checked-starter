package cn.xiaocai.limit.core.v2.aop;


import cn.xiaocai.limit.core.v2.annotation.LimitChecked;
import cn.xiaocai.limit.core.v2.auto.LimitCheckedProperties;
import cn.xiaocai.limit.core.v2.cache.MyCacheManager;
...
public class LimitCheckedAspect {
     ...
     */
    @Order(100)
    @Pointcut("@annotation(cn.xiaocai.limit.core.v2.annotation.LimitChecked)")
